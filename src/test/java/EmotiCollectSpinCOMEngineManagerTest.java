...
public class EmotiCollectSpinCOMEngineManagerTest {
	...
	private long[] noWinForce = {  1250000, // division 9
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(EmotiCollectSpinCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectSpinIWCOM/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectSpinIWCOM/InitOutcome.xml").getDocumentElement();
	...
	public void test_buy_200x_2000000CreditsWin_RevealThreeTimes() throws Exception {
		...
		assertEquals("Wager", JXPathUtil.getString(outcome, "//NextStage/text()"));
		assertSettledPendingPayout(outcome, pricePoint, 0, 8000000);
	}
